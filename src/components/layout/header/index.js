  ...
  return (
    <>
      <div
        ...
        <div className='w-[90vw] max-w-6xl h-full   flex justify-start items-center gap-[22rem] '>
          ...
          <div className=' flex gap-16 text-black font-normal justify-center items-center'>
            <Link
              to='hero'
              spy={true}
              smooth={true}
