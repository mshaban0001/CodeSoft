  ...
  return (
    <div className='w-full flex justify-center items-center h-[100vh] '>
      ...
      <div className='w-2/4 h-full flex items-center flex-col justify-center '>
        <h1 className='text-2xl font-extrabold relative left-[-29.75rem] uppercase tracking-widest text-[#3e64ff] '>
          Hey ! I Am
        </h1>
        <h1 className='text-5xl font-extrabold relative left-[-29rem] top-4  tracking-wide '>
          Muhammad Shaban
        </h1>
        <h1 className='text-3xl font-extrabold relative left-[-29rem] top-8  tracking-wide '>
          I'm a{' '}
          <span className='text-[#3e64ff]'>
            Front-end Web Application Developer
          </span>
        </h1>
        <div class='relative left-[-29.85rem] top-40'>
